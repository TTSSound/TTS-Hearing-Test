...
//                        .multilineTextAlignment(.leading)
//                        .padding([.leading, .bottom, .trailing])
                    Text("4. After making these changes, press the 'Test Settings' button below, which will confirm your device is configured for a calibrated and valid test. ")
                        .fontWeight(.bold)
                        .foregroundColor(.white)
                        .multilineTextAlignment(.leading)
                        .padding([.leading, .bottom, .trailing])
                    Text("5. If an issue is found when testing your device settings, you will be notified of what setting requires further adjustment.")
                        .fontWeight(.bold)
                        .foregroundColor(.white)
                        .multilineTextAlignment(.leading)
                        .padding([.leading, .bottom, .trailing])
