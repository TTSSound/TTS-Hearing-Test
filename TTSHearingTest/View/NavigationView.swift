...
struct NavigationView: View {
    ...
    @State var firstTestingTabValueArray = [nil, TTS_Hearing_Test.Testing(id: 8.0, name: "Beta Testing Home", related: [])]
    @State var firstTestingTabValue = TTS_Hearing_Test.Testing(id: 0.0, name: "", related: [])
    
    @State var secondTestingTabEnabled: Bool = false
    @State var secondTestingTabValueArray = [nil, TTS_Hearing_Test.EHATesting(id: 14.1, name: "EHA Interim Pre Part 2 Test", related: [])]
    @State var secondTestingTabValue = TTS_Hearing_Test.EHATesting(id: 0.0, name: "", related: [])
    
    @State var closingTabEnabled: Bool = false
    @State var closingTabValueArray = [nil, TTS_Hearing_Test.Closing(id: 15.0, name: "Results Landing View", related: [])]
    @State var closingTabValue = TTS_Hearing_Test.Closing(id: 0.0, name: "", related: [])
...
//                colorModel.colorBackgroundTiffanyBlue.ignoresSafeArea(.all, edges: .top)
                VStack(alignment: .leading) {
                    ...
                    HStack{
                        VStack(alignment: .leading) {
                            Text("PROCESS FLOW OF APP FOR ALPHA USE.")
                                ...
                                .padding(.leading)
                                .padding(.bottom, 10)
                            Text("COMPLETE TEST STEPS IN THIS ORDER")
                                .foregroundColor(.white)
                                .font(.title2)
                                .padding(.leading)
                    ...
                    .padding(.bottom, 20)
                    Text("1. Toggle & Start With 1st Testing Tab\n2. Return Home When Complete\n3. Then Toggle and Access The 2nd Testing Tab.\n\n\nSet Your Volume 10 100%, Turn On Do Not Disturb, Turn Off Silent Mode, and Proceed!")
                        .foregroundColor(colorModel.sunriseOrange)
                        .padding(.leading)
                        .padding(.bottom, 20)
                    Text("2nd Testing Tab Disabled as Default.\nEnable it by Toggle After Completing the First Test Phase.")
                        .foregroundColor(.white)
                        .padding(.leading)
                        .padding(.bottom, 20)
                    Spacer()
                    ...
                    HStack{
                        ...
                        .onChange(of: firstTestingTabEnabled) { newValue in
                            firstTestingTabValue = firstTestingTabValueArray[1] ?? TTS_Hearing_Test.Testing(id: 8.0, name: "Beta Testing Home", related: [])
                        }
                        Spacer()
                    ...
                    HStack{
                        ...
                        .onChange(of: secondTestingTabEnabled) { newValue in
                            secondTestingTabValue = secondTestingTabValueArray[1] ?? TTS_Hearing_Test.EHATesting(id: 14.1, name: "EHA Interim Pre Part 2 Test", related: [])
                        }
                        Spacer()
...
//                            closingTabValue = closingTabValueArray[1] ?? TTS_Hearing_Test.Closing(id: 15.0, name: "Results Landing View", related: [])
//                        }
//                        Spacer()
...
//                    .padding(.bottom, 20)
                ...
                NavigationStack(path: $navigationModel.earSimulatorPath) {
                    ZStack{
                        ...
                        VStack(alignment: .leading, spacing: 20) {
                            ...
                            HStack{
                                Spacer()
                                NavigationLink("Ear Simulators", value: TTS_Hearing_Test.EarSimulator(id: 20.0, name: "Ear Simulator Landing", related: []))
                                    .font(.title)
                                    .padding()
            ...
            .onAppear {
                getLinks()
                firstTestingTabValue = TTS_Hearing_Test.Testing(id: 0.0, name: "", related: [])
            }
            .tabItem {
...
//                        .padding(.trailing, 10)
//                        Spacer()
//                        NavigationLink("Let's Begin The Setup Process", value: TTS_Hearing_Test.Setup(id: 1.0, name: "Disclaimer", related: []))
//                            .font(.title)
//                            .padding()
//                            .frame(width: 300, height: 100, alignment: .center)
//                            .background(LinearGradient(colors: [Color(red: 0.333333333333333, green: 0.325490196078431, blue: 0.643137254901961), Color(red: 0.266666666666667, green: 0.043137254901961, blue: 0.843137254901961)], startPoint: UnitPoint(x: 0.3, y: 0.3), endPoint: UnitPoint(x: 0.9, y: 0.4)))
...
//                    NavigationLink("Let's Begin Testing!", value: TTS_Hearing_Test.Testing(id: 8.0, name: "Beta Testing Home", related: []))
...
//                            Spacer()
//                            NavigationLink("EPTA EHA Part 1 Test", value: TTS_Hearing_Test.Testing(id: 12.0, name: "EPTA EHAP1 Test", related: []))
//                                .font(.title)
//                                .padding()
//                                .frame(width: 300, height: 100, alignment: .center)
//                                .background(LinearGradient(colors: [Color(red: 0.333333333333333, green: 0.325490196078431, blue: 0.643137254901961), Color(red: 0.266666666666667, green: 0.043137254901961, blue: 0.843137254901961)], startPoint: UnitPoint(x: 0.3, y: 0.3), endPoint: UnitPoint(x: 0.9, y: 0.4)))
            ...
            NavigationStack(path: $navigationModel.ehaTestingPath) {
                ZStack{
                    ...
                    if secondTestingTabEnabled == true {
                        VStack{
                            NavigationLink("Let's Begin The Full EHA Test!", value: TTS_Hearing_Test.EHATesting(id: 14.1, name: "EHA Interim Pre Part 2 Test", related: []))
                                .font(.title)
                                .padding()
                                .frame(width: 300, height: 100, alignment: .center)
                                .background(LinearGradient(colors: [Color(red: 0.333333333333333, green: 0.325490196078431, blue: 0.643137254901961), Color(red: 0.266666666666667, green: 0.043137254901961, blue: 0.843137254901961)], startPoint: UnitPoint(x: 0.3, y: 0.3), endPoint: UnitPoint(x: 0.9, y: 0.4)))
...
////                    NavigationLink("Let's Go View Your Results!", value: TTS_Hearing_Test.Closing(id: 15.0, name: "Results Landing View", related: []))
...
//            .tag(5)
            ...
            //            }
//            NavigationStack(path: $navigationModel.setupPath) {
//                NavigationLink("Disclaimer", value: TTS_Hearing_Test.Setup(id: 1.0, name: "Disclaimer", related: []))
//                    .foregroundColor(.blue)
//                    .navigationDestination(for: Setup.self) { setup in
//                        DisclaimerView(setup: setup, relatedLink: link)
//                    }
